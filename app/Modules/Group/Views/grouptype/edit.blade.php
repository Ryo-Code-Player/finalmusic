            ...
            <form method="post" action="{{ route('admin.grouptype.update', $grouptype->id) }}">
                ...
                <div class="intro-y box p-5">
                    ...
                    <div class="mt-3">
                        ...
                        <input id="title" name="title" type="text" class="form-control" placeholder="vd: nhóm truyền thống" value="{{ old('title', $grouptype->title) }}">
                        @error('title')
                    ...
                    <div class="mt-3">
                        ...
                        <input id="type_code" name="type_code" type="text" class="form-control" placeholder="default" value="{{ old('type_code', $grouptype->type_code) }}">
                        @error('type_code')
                            <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                    </div>
