...
<div class="intro-y flex items-center mt-8">
    <h2 class="text-lg font-medium mr-auto">Thêm Nhạc Sĩ</h2>
</div>
<div class="grid grid-cols-12 gap-12 mt-5">
    <div class="intro-y col-span-12 lg:col-span-12">
        <form method="post" action="{{ route('admin.composer.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="intro-y box p-5">
                <div class="mt-3">
                    <label for="fullname" class="form-label">Tên Nhạc Sĩ</label>
                    <input id="fullname" name="fullname" type="text" class="form-control" placeholder="Họ Và Tên Nhạc Sĩ" value="{{ old('fullname') }}" required>
                </div>
...
<script>
    // Khởi tạo Tom Select cho trường tags (nếu cần)
