...
<div class="intro-y flex items-center mt-8">
    <h2 class="text-lg font-medium mr-auto">Thêm Listener</h2>
</div>
<div class="grid grid-cols-12 gap-12 mt-5">
    <div class="intro-y col-span-12 lg:col-span-12">
        <form method="post" action="{{ route('admin.listener.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="intro-y box p-5">
                ...
                <div class="form-group">
                    ...
                    <select name="favorite_type" id="favorite_type" class="form-control" required>
                        ...
                        <option value="composer">Nhà soạn nhạc</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="favorite_singer" id="favorite_singer" class="form-control">
                        ...
                        @foreach($singers as $singer)
                            <option value="{{ $singer->id }}">{{ $singer->alias }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="favorite_composer" id="favorite_composer" class="form-control">
                        ...
                        @foreach($composers as $composer)
                            <option value="{{ $composer->id }}">{{ $composer->fullname }}</option>
                        @endforeach
                    </select>
                </div>
