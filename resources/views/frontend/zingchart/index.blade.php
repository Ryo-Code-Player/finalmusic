...
<div class="zc-container">
    <div style="margin-bottom: 20px;">
        <button id="sortButton" class="zc-tab" style="margin-left: 12px;">
            <span>Sắp xếp theo tên</span>
            <span id="sortIcon" style="margin-left: 8px;">↓</span>
        </button>
    </div>
    <table class="zc-table" id="songTable">
        <thead>
            <tr>
                <th></th>
                <th>BÀI HÁT</th>
...
document.getElementById('sortButton').addEventListener('click', function() {
    ...
    // Sort rows
    rows.sort((a, b) => {
        const titleA = a.querySelector('.zc-song-title').textContent.toLowerCase();
        const titleB = b.querySelector('.zc-song-title').textContent.toLowerCase();
