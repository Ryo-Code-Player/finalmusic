...
@include('backend.layouts.notification')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="{{route('admin.role.create')}}" class="btn btn-primary shadow-md mr-2">Thêm role</a>
                        ...
                        <td class="table-report__action w-56">
                            ...
                            <div class="dropdown py-3 px-1 ">  
                                ...
                                <div class="dropdown-menu w-40"> 
                                    ...
                                    <li><a class="dropdown-item" href="{{route('admin.role.function',$item->id)}}" class="flex items-center mr-3" href="javascript:;"> <i data-lucide="eye" class="w-4 h-4 mr-1"></i> Phân quyền</a></li>
                                    <li><a class="dropdown-item" href="{{route('admin.role.edit',$item->id)}}" class="flex items-center mr-3" href="javascript:;"> <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Edit </a></li>
